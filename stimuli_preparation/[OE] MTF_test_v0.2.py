...
# ===== 參數設定 =====
name = "Web"
image_path = r"C:\Users\Asus_user\Desktop\Python Code\MTF test pattern\Web.png"     #圖片位置
save_path = r"C:\Users\Asus_user\Desktop\Python Code\MTF test pattern\\"    #儲存圖片位置
pixel_size_mm = 0.005649806841172989     # fiexd(panel規格)
frequency_lpmm = 44.25       # fixed(panel規格)
